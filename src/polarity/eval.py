...
parser.add_argument('--data_dir', type=str, default='dataset/Restaurants16')
parser.add_argument('--vocab_dir', type=str, default='dataset/Restaurants16')
...
print("token_vocab: {}, post_vocab: {}, pos_vocab: {}, dep_vocab: {}, pol_vocab: {}".format(
